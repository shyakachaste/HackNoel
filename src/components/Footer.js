  ...
  return (
    <footer className="footer">
      <div className="social-icons">
        ...
        <a href="https://www.instagram.com/youthcodecamp_rw/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
      ...
      Youth Code Camp is fiscally sponsored by The Hack Foundation (d.b.a. Hack Club), a 501(c)(3) nonprofit (EIN: 81-2908499).
      </p>
    </footer>
  );
};
